  ...
  return (
    <>
      <div
        ...
        }  ${done ? "bg-gray-900/50" : "bg-gray-900/80 hover:bg-gray-900/60"}`}
        onMouseEnter={() => setHoveredTodoId(id)} // Set hovered item ID
                ...
                <button>
                  {!done && (
                    <svg
                      ...
                      viewBox="0 0 20 20"
                      onClick={(e) => {
                        navigate(`/myday/tasks/${id}/activity`);
                      }}
                    >
                      <path
                        fill="#949494"
        ...
        <div className="flex items-center space-x-2">
              ...
              {done ? (
                <div className="bg-blue-500 rounded-full md:p-[0.15rem] md:mt-[0.55rem] mt-[0.50rem]">
                  <svg
                    ...
                    viewBox="0 0 14 12"
                    aria-hidden="true"
                    onClick={() => handleUpdateTodo(id, { done: false })}
                  >
                    <path
                      fill="currentColor"
                      fillRule="evenodd"
                ...
                <svg
                  ...
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                  onClick={() => handleUpdateTodo(id, { done: true })}
                >
                  <circle
                    cx="12"
                    cy="14"
          ...
          <p
            className={`text-white font-semibold mt-2 text-sm md:text-base lg:text-xl ${
              done ? "line-through text-gray-300/55" : "text-white"
            }`}
          >
            {title}
          </p>
