...
const Dashboard: React.FC<SidebarProps> = ({ currentUser }) => {
  ...
  return (
    <div className="flex flex-col p-8 dashboard-img text-white h-full mt-6 ">
      {/* Header Section */}
      <div className="mb-5 md:mx-auto md:ml-[8rem]  sm:ml-[8rem]">
        <h1 className="md:text-3xl text-md font-bold">
          {greeting}, {currentUser?.username}
        </h1>
        <p className="md:text-3xl text-md  text-gray-400 mt-1 font-semibold">
      ...
      <div className="flex items-center justify-between p-4 bg-gray-900/60 rounded-lg mb-6 shadow-lg md:w-[60rem] w-[24rem] mx-auto md:text-xl ml-[-0.20rem] md:mx-auto">
        <div>
          <p className="text-md font-[750] text-white ml-2 ">
            {currentDate.day}
          </p>
