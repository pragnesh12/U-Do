    ...
    <>
      ...
      >
        {todo.map((item: any) => (
          <div
            key={item.id}
            className={` p-3 rounded-lg shadow-lg mt-4 hover:bg-gray-900/60 mr-2 ${
              checkedStates[item.id] ? "bg-gray-900/50" : "bg-gray-900/70"
            }`}
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                <div className="TaskItemCheckbox__checkboxAsset">
                  {checkedStates[item.id] ? (
                    <div className="bg-gray-500 rounded-full md:p-[0.15rem] md:mt-1 mt-[0.50rem]">
                      <svg
                        className="w-[1rem] h-[1rem] md:w-[1.10rem] md:h-[1.10rem] lg:w-[1.10rem] lg:h-[1.10rem]"
                        viewBox="0 0 14 12"
                        aria-hidden="true"
                      >
                        <path
                    ...
                    !checkedStates[item.id] && (
                      <svg
                        className="w-[1.10rem] h-[1.10rem] md:w-[1.50rem] md:h-[1.50rem] lg:w-[1.50rem] lg:h-[1.50rem] mt-[0.30rem] md:mt-[0.10rem]"
                        viewBox="0 0 24 24"
                        aria-hidden="true"
                      >
                        <circle
              ...
              <div className="flex items-center justify-between !overflow-y-hidden md:mb-[0.30rem]">
                <p
